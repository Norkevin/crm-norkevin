...
try {
    ...
    $phases = @(
        ...
        @{ name = "daily_usage"; summaryKey = "daily_usage";
           ...
           exe = $pythonCmd; argsList = @('-m', 'pytest', 'tests\test_job_estado_activo_completo.py', 'tests\test_uso_diario_jobs.py', 'tests\test_job_clients_n_y_schedules.py', 'tests\test_uso_diario_clientes.py', 'tests\test_uso_diario_workflows_calendario.py', 'tests\test_navegacion_diaria.py', 'tests\test_paginas_de_error_y_marca.py', 'tests\test_rendimiento_vistas.py', 'tests\test_responsive_movil.py', 'tests\test_documento_web_pdf_paridad.py', 'tests\test_quote_services.py', 'tests\test_uso_diario_pantallas.py', 'tests\test_marca_en_documentos_cliente.py', '-v'); needsPytest = $true },
